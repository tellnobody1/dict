...
\hypertarget{bug}{\entry{bug}{хиба (у коді), вада (програми), дефект}}\\
...
\entry{commit}{вно́сити (\textit{процес}), вне́\-сок (\textit{результат})}\\
...
\entry{defect}{\textit{те саме, що} \hyperlink{bug}{bug}}\\
...
\entry{directory}{до́ві́дни́к, \textit{те саме, що} \hyperlink{folder}{folder}}\\
...
\section{I}
\entry{influencer}{впливач (-ка), намо́жник (-иця)}
